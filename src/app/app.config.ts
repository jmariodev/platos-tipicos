...
import {
    Facebook, Twitter, Instagram, MapPin, ArrowRight, Search, ChevronDown,
    Filter, Mail, User, Clock, ChefHat, Users, Sparkles, ArrowLeft,
    LayoutDashboard, Plus, Pencil, Trash2, Save, X, Tag, Menu
} from 'lucide-angular';
