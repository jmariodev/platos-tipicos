...
export class PlatoRepositoryImpl extends PlatoRepository {
    ...
    private apiUrl = 'assets/mock/platos.json';
    // TODO: Cambiar por la URL del API real, ej: 'http://localhost:8080/api/platos'
    ...
    getPlatoById(id: number): Observable<Plato | undefined> {
        ...
        // TODO: Cambiar por this.http.get<Plato>(`${this.apiUrl}/${id}`)
    }
